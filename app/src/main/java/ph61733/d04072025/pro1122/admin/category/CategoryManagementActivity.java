...
public class CategoryManagementActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView() {
        ...
        categoryAdapter = new com.example.da1.admin.category.CategoryAdapter(categoryList, new com.example.da1.admin.category.CategoryAdapter.OnCategoryClickListener() {
            @Override
