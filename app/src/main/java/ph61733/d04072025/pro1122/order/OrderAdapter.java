...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.OrderViewHolder> {
    private List<com.example.da1.admin.order.Order> orderList;
    private OnOrderClickListener listener;

    public interface OnOrderClickListener {
        void onViewClick(com.example.da1.admin.order.Order order);
        void onStatusChangeClick(com.example.da1.admin.order.Order order);
    }

    public OrderAdapter(List<com.example.da1.admin.order.Order> orderList, OnOrderClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull OrderViewHolder holder, int position) {
        com.example.da1.admin.order.Order order = orderList.get(position);
        holder.bind(order);
    }
    ...
    class OrderViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(com.example.da1.admin.order.Order order) {
